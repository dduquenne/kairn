...
export function generateMockSummary() {
  const sections = [
    'Accueil',
    'À propos',
    'Services - Psychothérapie individuelle',
    'Services - Psychothérapie de couple',
    'Services - Thérapie transpersonnelle',
    'Services - Hypnose Ericksonienne',
    'Blog',
    'Contact',
    'Séminaires',
    'FAQ'
...
/**
 * Liste des slugs d'articles de blog réels du site Psypnos
 */
const BLOG_ARTICLE_SLUGS = [
  'comprendre-hypnose-ericksonienne',
