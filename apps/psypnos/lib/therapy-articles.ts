...
/**
 * Mots-clés pour la psychothérapie
...
/**
 * Mots-clés pour l'hypnose
 */
export const HYPNOSIS_KEYWORDS = [
  // Termes principaux hypnose
  "hypnose",
  "hypnotherapie",
  "hypnotique",
  "erickson",
...
/**
 * Mots-clés pour la respiration holotropique
 */
...
const THERAPY_NAMES: Record<TherapyType, string> = {
  ...
  hypnosis: "hypnose",
  holotropic: "respiration holotropique",
};
...
/**
 * Filtre les articles pour la page psychothérapie
 */
...
/**
 * Filtre les articles pour la page hypnose
 */
...
/**
 * Filtre les articles pour la page respiration holotropique
 */
