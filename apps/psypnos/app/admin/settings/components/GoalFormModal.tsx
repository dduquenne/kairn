                ...
                {(Object.keys(GOAL_TYPE_LABELS) as GoalType[]).map(type => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        <p className="text-ivory font-medium">{GOAL_TYPE_LABELS[type]}</p>
                        <p className="text-ivory/50 mt-1 text-xs">{GOAL_TYPE_DESCRIPTIONS[type]}</p>
                      </div>
                      {isSelected && (
          ...
          {step === 'details' && (
            ...
            >
              ...
              <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4">
                ...
                <p className="text-ivory mt-1 text-sm">{getGoalPreview()}</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="border-ivory/20 bg-night/60 text-ivory placeholder:text-ivory/40 w-full rounded-xl border px-4 py-3 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/40"
                />
              ...
              {formData.type === 'event' && (
                <>
                  ...
                  <div>
                    <label className="text-ivory mb-2 block text-sm font-medium">Action</label>
                    <input
                      type="text"
                  ...
                  {errors.event && <p className="text-sm text-red-400">{errors.event}</p>}
                </>
              )}
              ...
              {formData.type === 'duration' && (
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="text-ivory mb-2 block text-sm font-medium">Comparaison</label>
                    <select
                      ...
                      className="border-ivory/20 bg-night/60 text-ivory w-full rounded-xl border px-4 py-3 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/40"
                    >
            ...
            >
              <div className="border-gold/20 bg-gold/5 rounded-xl border p-4">
                <div className="flex items-start gap-3">
                  <DollarSign className="text-gold mt-0.5 h-5 w-5" />
                  <div>
                    <p className="text-ivory font-medium">Valeur monétaire</p>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    step={0.01}
                    placeholder="0"
                    className="border-ivory/20 bg-night/60 text-ivory placeholder:text-ivory/40 focus:border-gold focus:ring-gold/40 w-full rounded-xl border px-4 py-3 pr-12 focus:outline-none focus:ring-2"
                  />
                  <span className="text-ivory/50 absolute right-4 top-1/2 -translate-y-1/2">€</span>
                </div>
              ...
              <div className="border-ivory/10 bg-night/40 rounded-xl border p-4">
                <h4 className="text-ivory/70 text-sm font-medium">Exemples de valeurs</h4>
