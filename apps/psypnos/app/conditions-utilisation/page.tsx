...
export const metadata: Metadata = {
  ...
  description:
    "Conditions générales d'utilisation du site Psypnos. Règles d'utilisation, responsabilités et droits relatifs à l'utilisation de nos services.",
  openGraph: {
          ...
          <div className="space-y-10">
            ...
            <section className="space-y-4">
              <p className="text-ivory/80 text-base leading-relaxed">
                Bienvenue sur Psypnos. En accédant à ce site web et en utilisant nos services, vous
              ...
              <div className="text-ivory/80 space-y-3">
                <ul className="space-y-2">
                  <li className="border-ivory/10 bg-night/60 rounded-xl border px-4 py-3">
                    ...
                    psypnos.fr et l'ensemble de ses pages et fonctionnalités.
                  </li>
                  <li className="border-ivory/10 bg-night/60 rounded-xl border px-4 py-3">
                    <span className="text-ivory font-semibold">"Services"</span> désigne l'ensemble
                    des services proposés par Psypnos, incluant les fonctionnalités du site, les
            ...
            <section className="space-y-4">
              ...
              <div className="text-ivory/80 space-y-4">
                <p>
                  ...
                  sont la propriété de Psypnos et sont protégés par les lois françaises et
            ...
            <section className="space-y-4">
              ...
              <div className="text-ivory/80 space-y-3">
                <p>
                  Vous acceptez d'indemniser et de dégager de toute responsabilité Psypnos contre
            ...
            <section className="space-y-4">
              ...
              <div className="text-ivory/80 space-y-3">
                <p>
                  ...
                  titre informatif uniquement. Psypnos n'a aucun contrôle sur le contenu de ces
            ...
            <section className="space-y-4">
              ...
              <div className="text-ivory/80 space-y-3">
                <p>
                  Psypnos se réserve le droit de suspendre ou de résilier votre accès aux Services à
            ...
            <section className="space-y-4">
              ...
              <div className="text-ivory/80 space-y-3">
                <p>
                  Psypnos se réserve le droit de modifier les présentes Conditions d'Utilisation à
            ...
            <section className="space-y-4">
              ...
              <div className="text-ivory/80 space-y-3">
                ...
                <div className="border-ivory/10 bg-night/60 rounded-xl border px-4 py-4">
                  <p>
                    <span className="text-ivory font-semibold">Psypnos</span>
                    <br />
                    David Duquenne
                    <br />
                    Le Moulin d'en Bas
