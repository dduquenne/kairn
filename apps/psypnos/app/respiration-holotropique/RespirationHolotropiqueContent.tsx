      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-6xl">
          ...
          >
            ...
            >
              La respiration holotropique ouvre une porte vers votre monde intérieur. Porté par le
      ...
      <main className="mx-auto max-w-4xl px-6 py-16 sm:px-8">
        ...
        >
          ...
          >
            ...
            <p className="text-ivory/90 mb-6 text-lg leading-relaxed">
              La respiration holotropique est une <strong>technique de respiration profonde</strong>{' '}
          ...
          >
            ...
            <p className="text-ivory/90 mb-6 text-lg leading-relaxed">
              La respiration holotropique s'adresse à toute personne en quête de transformation,
          ...
          >
            ...
            <p className="text-ivory/90 mb-6 text-lg leading-relaxed">
              La respiration holotropique repose sur trois éléments fondamentaux qui, combinés,
            ...
            <div className="border-gold/20 bg-night/40 my-8 rounded-lg border p-8">
              <p className="text-gold/90 text-center text-xl font-light italic leading-relaxed">
                "Dans la respiration holotropique, nous ne cherchons pas à créer quelque chose de
          ...
          >
            <div className="border-gold/20 from-gold/10 to-gold/5 rounded-lg border bg-gradient-to-br p-8 text-center">
              ...
              <p className="text-ivory/70 mb-6">
                Rejoignez-nous pour un séminaire de respiration holotropique et découvrez ce que
        ...
        {seminars.length > 0 && (
          ...
          >
            ...
            <p className="text-ivory/70 mb-8 text-lg">
              Découvrez les prochaines dates pour vivre l'expérience de la respiration holotropique.
            </p>
        ...
        {posts.length > 0 && (
          ...
          >
            ...
            <p className="text-ivory/70 mb-8 text-lg">
              Découvrez mes articles pour mieux comprendre la respiration holotropique et ce qu'elle
              peut vous apporter.
            </p>
        ...
        >
          ...
          <p className="text-ivory/80 mb-8 text-lg">
            La respiration holotropique vous invite à rencontrer votre sagesse intérieure. Êtes-vous
