      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-6xl">
          ...
          >
            ...
            >
              Un espace pour{" "}
              <span className="text-gold">se retrouver</span>
            </motion.h1>
            <motion.p
            ...
            >
              La psychothérapie est un voyage vers soi, un chemin
              d'exploration et de transformation. Dans un cadre bienveillant
              et confidentiel, je vous accompagne pour traverser ce que vous
              traversez et retrouver votre équilibre intérieur.
            </motion.p>
            <motion.div
      ...
      <main className="mx-auto max-w-4xl px-6 py-16 sm:px-8">
        ...
        >
          ...
          >
            ...
            <p className="mb-6 text-lg leading-relaxed text-ivory/90">
              ...
              <strong>espace protégé</strong> où vous pouvez déposer ce qui vous pèse,
              explorer ce qui vous échappe et cheminer vers une meilleure compréhension
              de vous-même.
            </p>

            <p className="mb-6 text-lg leading-relaxed text-ivory/90">
              Contrairement aux idées reçues, consulter un thérapeute n'est pas
              réservé aux moments de crise profonde. Beaucoup de personnes entament
              une thérapie pour <strong>mieux se connaître</strong>, traverser une
              transition de vie, ou simplement parce qu'elles sentent que quelque
              chose doit changer.
            </p>

            <div className="my-8 rounded-r-lg border-l-4 border-gold/30 bg-gold/5 p-6">
              <p className="italic leading-relaxed text-ivory/80">
                "La psychothérapie ne consiste pas à devenir quelqu'un d'autre,
                mais à retrouver celui que nous avons toujours été, sous les couches
                de conditionnements et de blessures accumulées."
              </p>
            </div>

            <p className="text-lg leading-relaxed text-ivory/90">
              En séance, nous travaillons ensemble à votre rythme. Il n'y a pas
              de recette miracle ni de solution toute faite : chaque parcours est
              unique, adapté à votre histoire, vos besoins et vos ressources.
            </p>
          </motion.section>
          ...
          >
            ...
            <p className="mb-6 text-lg leading-relaxed text-ivory/90">
              Vous vous demandez peut-être si la thérapie pourrait vous aider.
              Voici quelques situations qui amènent souvent les personnes à consulter :
            </p>
            ...
            <p className="text-lg leading-relaxed text-ivory/90">
              Si vous vous reconnaissez dans l'une de ces situations, ou si vous
              ressentez simplement le besoin de parler à quelqu'un de confiance,
              la psychothérapie peut vous accompagner.
            </p>
          </motion.section>
          ...
          >
            ...
            <p className="mb-6 text-lg leading-relaxed text-ivory/90">
              Mon approche s'inscrit dans une <strong>psychothérapie transpersonnelle
              et intégrative</strong>, qui prend en compte toutes les dimensions de
              l'expérience humaine : psychique, émotionnelle, corporelle et existentielle.
            </p>

            <p className="mb-6 text-lg leading-relaxed text-ivory/90">
              Je m'appuie sur plusieurs outils thérapeutiques que j'adapte selon
              vos besoins et ce qui émerge en séance :
            </p>
            ...
            <div className="space-y-8">
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-ivory/80">
                    Vous me contactez via le formulaire de demande de rendez-vous.
                    Je vous réponds sous 48h pour convenir d'un premier entretien.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-ivory/80">
                    Nous faisons connaissance. Vous m'exposez ce qui vous amène,
                    vos attentes et vos questions. C'est aussi l'occasion de
                    sentir si le cadre vous convient.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-ivory/80">
                    Les séances suivantes (généralement hebdomadaires ou
                    bi-mensuelles) permettent d'approfondir le travail. La
                    fréquence s'adapte à vos besoins et votre rythme.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-ivory/80">
                    Quand vous vous sentez prêt, nous préparons ensemble la fin
                    de l'accompagnement. Vous repartez avec des outils et une
          ...
          >
            <div className="rounded-lg bg-gradient-to-br from-gold/10 to-gold/5 border border-gold/20 p-8 text-center">
              ...
              <p className="mb-6 text-ivory/70">
                La première rencontre est sans engagement. C'est l'occasion de
                voir si nous pouvons cheminer ensemble.
              </p>
              <CTAButton
                variant="primary"
                href="/demande-rendez-vous"
        ...
        {posts.length > 0 && (
          ...
          >
            ...
            <p className="mb-8 text-lg text-ivory/70">
              Découvrez mes articles pour mieux comprendre la psychothérapie et
        ...
        >
          ...
          <p className="mb-8 text-lg text-ivory/80">
            Que vous traversiez une crise, une transition ou une simple recherche
            de sens, je suis là pour vous accompagner.
          </p>
