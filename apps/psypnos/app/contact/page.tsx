            ...
            <div className="space-y-8">
              ...
              <div className="border-ivory/10 bg-night/30 rounded-2xl border p-6">
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="bg-gold hover:bg-gold/90 text-night focus-ring-offset w-full rounded-lg py-3 font-medium transition-colors"
                  >
                    Envoyer le message
                  </button>
              ...
              <div className="border-gold/20 bg-gold/5 rounded-2xl border p-6">
                ...
                <p className="text-ivory/70 mb-4 text-sm">
                  ...
                  des séances en visioconférence pour la psychothérapie et l&apos;hypnose.
                </p>
                <Link
                  href="/demande-rendez-vous"
