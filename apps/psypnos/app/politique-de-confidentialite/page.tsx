...
export const metadata: Metadata = {
  ...
  description:
    'Découvrez comment Psypnos collecte, utilise et protège vos données personnelles conformément au RGPD. Transparence et confidentialité garanties.',
  openGraph: {
  ...
  },
  {
    ...
    content: (
      <div className="text-ivory/80 space-y-6">
        <p>
          Les données collectées varient selon le type d’activité : psychothérapie ou hypnose
          individuelle, stages ou séminaires de respiration holotropique, formulaires de contact et
          de rendez-vous.
        </p>
      ...
      <main className="from-night via-night/95 to-night min-h-screen bg-gradient-to-b px-6 pb-12 pt-24 sm:px-10 lg:px-16">
        <article className="border-ivory/10 bg-night/60 shadow-night/40 mx-auto max-w-4xl space-y-16 rounded-3xl border p-10 shadow-xl">
          <header className="space-y-6 text-center">
            <p className="text-gold/80 text-sm uppercase tracking-[0.3em]">Psypnos</p>
            ...
            <p className="text-ivory/80 text-base">
              ...
              collectées, utilisées et protégées dans le cadre des services proposés par Psypnos, en
