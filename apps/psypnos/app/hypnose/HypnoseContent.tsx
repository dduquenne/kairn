      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-6xl">
          ...
          >
            ...
            >
              L'hypnose thérapeutique est une porte ouverte vers votre inconscient, là où résident
            ...
            >
              <CTAButton
                ...
                onTrack={() =>
                  trackConversionEvent('appointment_request', 'button_click_hypnose_hero', false)
                }
              >
      ...
      <main className="mx-auto max-w-4xl px-6 py-16 sm:px-8">
        ...
        >
          ...
          >
            ...
            <p className="text-ivory/90 mb-6 text-lg leading-relaxed">
              L'hypnose est un <strong>état naturel de conscience modifiée</strong> que vous
            ...
            <p className="text-ivory/90 mb-6 text-lg leading-relaxed">
              Contrairement aux représentations spectaculaires souvent véhiculées, l'hypnose
            ...
            <div className="border-gold/30 bg-gold/5 my-8 rounded-r-lg border-l-4 p-6">
              <p className="text-ivory/80 italic leading-relaxed">
                "L'hypnose ne vous donne pas de nouveaux pouvoirs. Elle vous reconnecte à ceux que
          ...
          >
            ...
            <p className="text-ivory/90 mb-6 text-lg leading-relaxed">
              L'hypnose thérapeutique est un outil polyvalent qui peut accompagner de nombreuses
            ...
            <p className="text-ivory/90 text-lg leading-relaxed">
              L'hypnose ne remplace pas un traitement médical mais peut l'accompagner efficacement.
          ...
          >
            ...
            <p className="text-ivory/90 mb-6 text-lg leading-relaxed">
              Je pratique l'<strong>hypnose ericksonienne</strong>, une approche développée par le
              psychiatre américain Milton Erickson. Cette forme d'hypnose est particulièrement
              respectueuse et permissive : elle s'adapte à vous plutôt que de vous imposer un cadre
              rigide.
            </p>

            <p className="text-ivory/90 mb-6 text-lg leading-relaxed">
              L'hypnose ericksonienne utilise le langage de manière subtile pour accompagner en
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-ivory/80">
                    ...
                    démystifier l'hypnose si vous avez des appréhensions.
                  </p>
                </div>
              </div>
          ...
          >
            <div className="from-gold/10 to-gold/5 border-gold/20 rounded-lg border bg-gradient-to-br p-8 text-center">
              ...
              <p className="text-ivory/70 mb-6">
                La première séance est l'occasion de faire connaissance et de découvrir l'hypnose en
                toute sécurité.
              </p>
              <CTAButton
                variant="primary"
        ...
        {posts.length > 0 && (
          ...
          >
            ...
            <p className="text-ivory/70 mb-8 text-lg">
              Découvrez mes articles pour mieux comprendre l'hypnose et ce qu'elle peut vous
              apporter.
            </p>
        ...
        >
          ...
          <p className="text-ivory/80 mb-8 text-lg">
            ...
            explorer votre monde intérieur, l'hypnose peut vous y aider.
          </p>
          <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
            <CTAButton
              ...
              href="/demande-rendez-vous"
              onTrack={() =>
                trackConversionEvent('appointment_request', 'button_click_hypnose_cta_final', false)
              }
            >
              Demander un rendez-vous
            </CTAButton>
