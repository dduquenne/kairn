      ...
      >
        <div className="mx-auto max-w-6xl space-y-12 text-center">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
            <CTAButton variant="primary" className="mt-auto" href="/demande-rendez-vous">
              Demander un rendez-vous
            </CTAButton>
            <CTAButton variant="secondary" className="mt-auto" href="/psychotherapie">
              En savoir plus
            </CTAButton>
          </div>
        </div>
      ...
      >
        <div className="mx-auto max-w-6xl space-y-12 text-center">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
            ...
            <CTAButton variant="secondary" className="mt-auto" href="/hypnose">
              En savoir plus
            </CTAButton>
          </div>
        </div>
