    ...
    <div className={`${containerClasses} ${className}`}>
      {socialLinks.map((link, index) => (
        <motion.a
          ...
          className={`focus:ring-gold focus:ring-offset-night group flex items-center gap-2 rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 ${
            variant === 'inline'
              ? 'text-ivory/60 hover:text-gold hover:bg-gold/10 p-2'
              : 'text-ivory/70 hover:text-gold hover:bg-gold/10 px-4 py-2'
          }`}
        >
          <span
