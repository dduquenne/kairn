...
/**
 * Request type options for Psypnos
 */
...
/**
 * Psypnos-specific colors matching the site theme
 */
...
/**
 * Psypnos-specific labels (French)
 */
const PSYPNOS_LABELS = {
...
/**
 * Floating Action Button with contact form - Psypnos-specific wrapper
 *
 * This component wraps the shared FloatingContactButton from @kairn/ui
 * and provides Psypnos-specific configuration and dependencies.
 */
export function PsypnosFloatingContactButton() {
  const csrf = useCSRF();
...
export default PsypnosFloatingContactButton;
