...
export const metadata: Metadata = {
  title: 'Sophrologie & Somatothérapie dans l\'Yonne (89) | Toutes nos localisations',
  description:
    'Cabinet de sophrologie, somatothérapie et breathwork à Saint-Julien-du-Sault, au service de l\'Yonne (89). Accessible depuis Auxerre, Sens, Joigny, Migennes et toute la Bourgogne.',
  keywords: [
    'sophrologie Yonne',
    ...
    'cabinet bien-être Yonne',
  ],
  openGraph: {
    title: 'Sophrologie & Somatothérapie dans l\'Yonne - Appréciez Votre Vie',
    description:
      'Retrouvez nos services de bien-être partout dans l\'Yonne : Auxerre, Sens, Joigny, Migennes et alentours.',
    url: 'https://appreciezvotrevie.fr/yonne',
    type: 'website',
    images: [
      {
        url: 'https://appreciezvotrevie.fr/images/cabinet-moulin.webp',
        width: 1200,
        height: 630,
        alt: 'Cabinet de sophrologie - Le Moulin d\'en Bas',
      },
    ],
  },
  alternates: {
    canonical: 'https://appreciezvotrevie.fr/yonne',
  },
};
...
const departmentServices = [
  {
    service: 'Sophrologie & Relaxation',
    icon: Brain,
    href: '/sophrologie-yonne',
    description: 'Gestion du stress, relaxation et développement de la sérénité',
  },
  {
    service: 'Somatothérapie',
    icon: Sparkles,
    href: '/somatotherapie-yonne',
    description: 'Libération des tensions corporelles et blocages émotionnels',
  },
  {
    service: 'Breathwork & Rebirth',
    icon: Wind,
    href: '/breathwork-yonne',
    description: 'Séminaires de transformation personnelle par le souffle',
  },
];
...
function getJsonLd() {
  return {
    ...
    '@graph': [
      {
        '@type': 'CollectionPage',
        '@id': 'https://appreciezvotrevie.fr/yonne#webpage',
        url: 'https://appreciezvotrevie.fr/yonne',
        name: 'Sophrologie & Somatothérapie dans l\'Yonne - Toutes nos localisations',
        description:
          'Cabinet de sophrologie et somatothérapie au service de l\'Yonne : Auxerre, Sens, Joigny, Migennes et alentours.',
        isPartOf: {
        ...
        breadcrumb: {
          ...
          itemListElement: [
            ...
            },
            {
              ...
              position: 2,
              name: 'Yonne',
              item: 'https://appreciezvotrevie.fr/yonne',
            },
          ],
        },
      },
      {
        ...
        '@id': 'https://appreciezvotrevie.fr/yonne#business',
        name: 'Appréciez Votre Vie - Bien-être dans l\'Yonne',
        description:
          'Services de sophrologie, somatothérapie et breathwork pour les habitants de l\'Yonne',
        url: 'https://appreciezvotrevie.fr/yonne',
        areaServed: [
          {
      ...
      {
        '@type': 'FAQPage',
        '@id': 'https://appreciezvotrevie.fr/yonne#faq',
        mainEntity: [
          {
            '@type': 'Question',
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Oui, des consultations en visioconférence sont proposées pour la sophrologie et la somatothérapie. Cette option est idéale si vous habitez loin du cabinet ou si vous avez des difficultés à vous déplacer.',
            },
          },
          {
            '@type': 'Question',
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="text-center">
              ...
              <h1 className="font-display text-4xl font-bold text-ivory sm:text-5xl lg:text-6xl">
                Bien-être dans l'Yonne
              </h1>
              <p className="mx-auto mt-6 max-w-3xl text-lg text-ivory/70 leading-relaxed">
                Cabinet de sophrologie, somatothérapie et breathwork à Saint-Julien-du-Sault,
            ...
            <div className="grid gap-12 lg:grid-cols-2">
              <div>
                ...
                <p className="mb-6 text-ivory/70 leading-relaxed">
                  ...
                  Ce lieu paisible et ressourçant offre un cadre idéal pour un accompagnement
                  vers le bien-être et la reconnexion à soi.
                </p>
                ...
                <div className="space-y-4">
                  <details className="group">
                    ...
                    <p className="mt-2 text-sm text-ivory/60">
                      Oui, des consultations en visioconférence sont proposées pour la sophrologie
                      et la somatothérapie. Cette option est idéale si vous habitez loin ou avez des
