...
export const metadata: Metadata = {
  title: 'Contact & Accès | Cabinet de sophrologie à Saint-Julien-du-Sault',
  description:
    "Contactez Nathalie Duquenne, cabient de sophrologie à Saint-Julien-du-Sault (89). Le Moulin d'en Bas. Accès depuis Sens, Auxerre, Joigny, Paris. Formulaire de contact et itinéraires.",
  keywords: [
    'contact sophrologue Yonne',
    'cabinet sophrologie Saint-Julien-du-Sault',
    'rdv somatothérapie Sens',
    'accès cabinet Auxerre',
    'sophrologue Joigny contact',
  ],
  openGraph: {
    title: 'Contact & Accès - Cabinet Appréciez Votre Vie',
    description:
      "Prenez rendez-vous avec Nathalie Duquenne. Cabinet Le Moulin d'en Bas à Saint-Julien-du-Sault. Consultations en présentiel et en visioconférence.",
    url: 'https://appreciezvotrevie.fr/contact',
    type: 'website',
  },
  alternates: {
    canonical: 'https://appreciezvotrevie.fr/contact',
  },
};
...
function generateContactPageSchema() {
  return {
    ...
    '@type': 'ContactPage',
    '@id': 'https://appreciezvotrevie.fr/contact',
    name: 'Contact - Appréciez Votre Vie',
    description: 'Page de contact du cabinet Appréciez Votre Vie - Nathalie Duquenne',
    url: 'https://appreciezvotrevie.fr/contact',
    mainEntity: {
      '@type': 'LocalBusiness',
...
const ParkingIcon = () => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M3 6a3 3 0 013-3h12a3 3 0 013 3v12a3 3 0 01-3 3H6a3 3 0 01-3-3V6zm6 3a.75.75 0 01.75-.75h2.5a2.25 2.25 0 010 4.5h-1.75v1.5a.75.75 0 01-1.5 0V9zm1.5 2.25h1.75a.75.75 0 000-1.5h-1.75v1.5z"
      clipRule="evenodd"
    />
  </svg>
);
...
const DIRECTIONS = [
  {
    ...
    duration: '25 min',
    description:
      'Depuis Sens, prendre la D606 direction Joigny. À Saint-Julien-du-Sault, suivre les panneaux "Le Moulin".',
    highlight: true,
  },
  {
    city: 'Joigny',
    ...
    duration: '15 min',
    description:
      'Depuis Joigny, prendre la D943 direction Sens. Traverser Saint-Julien-du-Sault, le cabinet est à la sortie du village.',
    highlight: true,
  },
  {
    city: 'Auxerre',
    ...
    duration: '40 min',
    description:
      "Depuis Auxerre, prendre l'A6 puis sortie Joigny. Suivre D943 vers Sens jusqu'à Saint-Julien-du-Sault.",
    highlight: false,
  },
  {
    city: 'Migennes',
    ...
    duration: '25 min',
    description:
      "Depuis Migennes, prendre la D943 direction Sens. Le cabinet se trouve à l'entrée de Saint-Julien-du-Sault.",
    highlight: false,
  },
  {
    city: 'Paris',
    ...
    duration: '1h30',
    description:
      'Depuis Paris, prendre l\'A6 direction Lyon. Sortie n°18 "Courtenay", puis suivre Sens et Saint-Julien-du-Sault.',
    highlight: false,
  },
  {
    city: 'Dijon',
    ...
    duration: '1h45',
    description:
      'Depuis Dijon, prendre l\'A6 direction Paris. Sortie "Auxerre Sud", puis D965 et D943 jusqu\'à Saint-Julien-du-Sault.',
    highlight: false,
  },
];
...
export default function ContactPage() {
  return (
    <div className="from-night via-night/95 to-night text-ivory min-h-screen bg-gradient-to-b">
      ...
      <main id="main-content" className="pb-16 pt-24" role="main">
        <div className="mx-auto max-w-7xl px-6 sm:px-10 lg:px-16">
          {/* Breadcrumb */}
          <Breadcrumb items={[{ name: 'Contact & Accès', href: '/contact' }]} className="mb-8" />

          {/* En-tête */}
          <header className="mb-12 text-center">
            <h1 className="font-display text-gold-accessible mb-4 text-4xl font-bold md:text-5xl">
              Contact & Accès
            </h1>
            <p className="text-ivory/70 mx-auto max-w-2xl text-lg">
              Prenez rendez-vous pour une consultation au cabinet de Saint-Julien-du-Sault ou en
              visioconférence. Je suis à votre écoute.
            </p>
          </header>
          ...
          <div className="grid gap-12 lg:grid-cols-2">
              ...
              <div className="overflow-hidden rounded-2xl">
                <div className="bg-night/50 aspect-video w-full">
                  <iframe
                    ...
                    title="Localisation du cabinet Appréciez Votre Vie à Saint-Julien-du-Sault"
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-ivory/70 text-sm">Parking gratuit et privé sur place</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-8">
              ...
              <div className="border-ivory/10 bg-night/30 rounded-2xl border p-6">
                <h2 className="font-display mb-6 text-xl font-semibold" id="contact-form-title">
              ...
              <div className="border-gold/20 bg-gold/5 rounded-2xl border p-6">
                <h3 className="font-display text-gold-accessible mb-2 font-semibold">
                  Consultation en visioconférence
                </h3>
                <p className="text-ivory/70 mb-4 text-sm">
                  Vous habitez loin ou préférez consulter depuis chez vous ? Je propose également
                  des séances en visioconférence pour la sophrologie et l&apos;somatothérapie.
                </p>
                <Link
                  href="/demande-rendez-vous"
          ...
          <section className="mt-16">
            <div className="mb-8 text-center">
              <h2 className="font-display text-gold-accessible mb-2 text-2xl font-bold">
              ...
              {DIRECTIONS.map(dir => (
                <div
                  ...
                  className={`rounded-xl border p-5 transition-colors ${
                    dir.highlight ? 'border-gold/30 bg-gold/5' : 'border-ivory/10 bg-night/30'
                  }`}
                >
          ...
          <section className="mt-16">
            <div className="border-ivory/10 bg-night/30 rounded-2xl border p-8">
              <h2 className="font-display text-gold-accessible mb-4 text-center text-2xl font-bold">
                Cabinet de sophrologie dans l&apos;Yonne
              </h2>
              ...
              <div className="flex flex-wrap justify-center gap-3">
                <Link
                  href="/sophrologie-yonne"
                  className="bg-ivory/5 hover:bg-ivory/10 rounded-full px-4 py-2 text-sm transition-colors"
                >
                  Sophrologie Yonne
                </Link>
                <Link
                  href="/sophrologie-auxerre"
                  className="bg-ivory/5 hover:bg-ivory/10 rounded-full px-4 py-2 text-sm transition-colors"
                >
                  Sophrologie Auxerre
                </Link>
                <Link
                  href="/sophrologie-sens"
                  className="bg-ivory/5 hover:bg-ivory/10 rounded-full px-4 py-2 text-sm transition-colors"
                >
                  Sophrologie Sens
                </Link>
                <Link
                  href="/somatotherapie-yonne"
                  className="bg-ivory/5 hover:bg-ivory/10 rounded-full px-4 py-2 text-sm transition-colors"
                >
                  Somatothérapie Yonne
                </Link>
                <Link
                  href="/breathwork-bourgogne"
                  className="bg-ivory/5 hover:bg-ivory/10 rounded-full px-4 py-2 text-sm transition-colors"
                >
