...
export const metadata: Metadata = {
  title: 'Sophrologie Sens | Nathalie Duquenne | Cabinet à 25 min',
  description:
    'Sophrologie près de Sens (89). Nathalie Duquenne, sophrologue certifiée, vous accueille à 25 min pour anxiété, burn-out, deuil. Cabinet au Moulin d\'en Bas.',
  keywords: [
    'sophrologie Sens',
    'sophrologue Sens',
    'thérapie Sens 89',
  ...
  openGraph: {
    title: 'Sophrologie près de Sens - Nathalie Duquenne',
    description: 'Cabinet de sophrologie à 25 min de Sens. Accompagnement pour anxiété, burn-out, transitions de vie.',
    url: 'https://appreciezvotrevie.fr/sophrologie-sens',
  },
  alternates: {
    canonical: 'https://appreciezvotrevie.fr/sophrologie-sens',
  },
};
...
const schemaData = {
  ...
  '@id': 'https://appreciezvotrevie.fr/sophrologie-sens',
  name: 'Appréciez Votre Vie - Sophrologie près de Sens',
  description: 'Cabinet de sophrologie accessible depuis Sens',
  url: 'https://appreciezvotrevie.fr/sophrologie-sens',
  areaServed: {
    '@type': 'City',
    name: 'Sens',
...
const mainContent = `
<p>Vous cherchez un accompagnement en <strong>sophrologie près de Sens</strong> ? Le cabinet Appréciez Votre Vie vous accueille à Saint-Julien-du-Sault, à seulement <strong>25 minutes en voiture</strong> de Sens via la D606.</p>
...
<h3>Sophrologie pour les Sénonais</h3>

<p>En tant que sophrologue, j'accompagne de nombreux habitants de Sens et de son agglomération : Paron, Saint-Clément, Maillot, Gron, Villeneuve-sur-Yonne...</p>
...
<p>Je pratique la <strong>sophrologie</strong>, une approche qui permet :</p>
<ul>
...
export default function SophrologieSensPage() {
  return (
    <GeoPage
      title="Sophrologie près de Sens"
      subtitle="Cabinet de sophrologie à 25 minutes de Sens"
      description="Nathalie Duquenne, sophrologue certifiée, accompagne les Sénonais dans un cabinet accessible, avec des horaires adaptés aux contraintes de chacun."
      service="sophrologie"
      location={{
        city: 'Sens',
        department: '89',
      ...
      breadcrumbItems={[
        ...
        { name: 'Sophrologie Sens', href: '/sophrologie-sens' },
      ]}
