...
/**
 * Client Component - Contenu biographique de Nathalie Duquenne
    ...
    <div className="from-night via-night/95 to-night text-ivory min-h-screen bg-gradient-to-b">
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-6xl">
          ...
          >
            ...
            >
              Nathalie Duquenne - <span className="text-gold">Sophrologie & Somatothérapie</span>
            </motion.h1>
            <motion.p
      ...
      <main className="mx-auto max-w-4xl px-6 py-16 sm:px-8">
        <article
          ...
          aria-label="Biographie de Nathalie Duquenne"
        >
          {/* Introduction */}
          <motion.section
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <p className="text-ivory/90 text-lg leading-relaxed">
              Mon approche s'inscrit dans une sophrologie et relaxation, intégrative et
          ...
          >
            ...
            <p className="text-ivory/90 mb-6 text-lg leading-relaxed">
              La rencontre avec la <strong>breathwork & rebirth</strong> et la{' '}
              <strong>sophrologie et relaxation</strong> a été décisive. Elle m'a permis de
            ...
            <p className="text-ivory/90 text-lg leading-relaxed">
              Plusieurs années plus tard, c'est grâce à l'<strong>somatothérapie</strong> que
              ...
              <strong>
                outil thérapeutique aussi puissant et complémentaire que la breathwork & rebirth
              </strong>
          ...
          >
            <h2 className="font-display text-gold-accessible mb-8 text-3xl font-semibold sm:text-4xl">
              Appréciez Votre Vie : un lieu, un passage
            </h2>
