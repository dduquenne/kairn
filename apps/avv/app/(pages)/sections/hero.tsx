...
const heroContent = {
  h1: 'Sophrologie, Relaxation & Somatothérapie à Saint-Julien-du-Sault (Yonne)',
  slogan1: 'Écouter son corps.',
  slogan2: 'Libérer son esprit.',
  subtitle:
    'Retrouvez harmonie et bien-être grâce à une approche douce qui réconcilie le corps et l\u2019esprit.',
  ctas: {
...
const heroPractitioner = {
  ...
  headline: 'Sophrologue, Relaxologue & Somatothérapeute',
  address: "Le Moulin d'en Bas – 89330 Saint-Julien du Sault",
  description:
    "Praticienne certifiée en sophrologie, relaxation et somatothérapie, je vous accompagne vers un mieux-être global en travaillant sur le lien entre le corps et l'esprit. Que vous souhaitiez relâcher des tensions, retrouver un sommeil réparateur, gérer vos émotions ou simplement vous reconnecter à vous-même, mon approche allie techniques corporelles douces et outils de relaxation profonde. Je suis convaincue que chacun porte en soi les ressources nécessaires pour retrouver son équilibre, et mon rôle est de vous guider sur ce chemin.",
};
          ...
          <div className="max-w-xl text-center lg:text-left">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-x-8 gap-y-4 lg:justify-start">
              ...
              >
                ...
                <span className="font-medium">Sophrologie</span>
              </Link>
              <Link
                href="#somatotherapie"
                className="text-ivory-muted hover:text-gold-accessible group inline-flex items-center gap-2 text-sm transition-all duration-300"
              >
                ...
                <span className="font-medium">Somatothérapie</span>
              </Link>
              <Link
                href="#breathwork"
                className="text-ivory-muted hover:text-gold-accessible group inline-flex items-center gap-2 text-sm transition-all duration-300"
              >
                ...
                <span className="font-medium">Breathwork</span>
              </Link>
              <Link
                href="#coherence-cardiaque"
                className="text-ivory-muted hover:text-gold-accessible group inline-flex items-center gap-2 text-sm transition-all duration-300"
              >
                <span className="border-ivory/20 bg-ivory/5 group-hover:border-gold/50 group-hover:bg-gold/10 flex h-8 w-8 items-center justify-center rounded-full border transition-all duration-300">
                  <svg
                ...
                <span className="font-medium">Cohérence cardiaque</span>
              </Link>
              <Link
                href="#reiki"
                className="text-ivory-muted hover:text-gold-accessible group inline-flex items-center gap-2 text-sm transition-all duration-300"
