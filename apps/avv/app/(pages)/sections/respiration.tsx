  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl space-y-12">
        <SectionTitle
          eyebrow="Breathwork & rebirth"
          title="Le corps est le chemin. Le souffle est le guide."
          description="La Breathwork & Rebirth ouvre une porte à un voyage intérieur extraordinaire. Porté par la respiration, la musique et un travail corporel spécifiques, ce voyage vous emmène dans des espaces d'introspection, d'enseignement, de libération, de guérison ou encore d'éveil.
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          ...
          >
            ...
            >
              ...
              <CTAButton variant="secondary" href="/breathwork">
                En savoir plus
              </CTAButton>
            </motion.div>
          </div>
