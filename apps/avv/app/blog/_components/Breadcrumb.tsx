...
export function BreadcrumbStructuredData({ post }: { post?: BlogPost }) {
  const items = [
    ...
    },
    {
      ...
      position: 2,
      name: "Blog",
      item: "https://appreciezvotrevie.fr/blog",
    },
  ];
    ...
    items.push(
      {
        ...
        position: 3,
        name: post.category,
        item: `https://appreciezvotrevie.fr/blog?category=${encodeURIComponent(post.category)}`,
      },
      {
        "@type": "ListItem",
        position: 4,
        name: post.title,
        item: `https://appreciezvotrevie.fr/blog/${post.slug}`,
      }
    );
  }
