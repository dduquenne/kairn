...
export interface ArticleGenerationOptions {
  ...
  // ✨ Nouveaux paramètres pour style AVV
 ...
 */
const AVV_TECHNICAL_INSTRUCTIONS = `
...
<IMAGE_PROMPT>Prompt image 1920×640px transpersonnel - style graphique conceptuel avec symbolique abstraite, cohérent avec l'identité visuelle Appréciez Votre Vie. Voir directives détaillées ci-dessous.</IMAGE_PROMPT>

---

## DIRECTIVES SPÉCIALES POUR <IMAGE_PROMPT>

Tu dois générer un prompt image qui respecte STRICTEMENT ces principes de l'identité visuelle Appréciez Votre Vie v2.0 :
...
Palette : [Or Appréciez Votre Vie (#c7a962), bleu nuit (#0e1f2f), ivoire (#f5f1e6) + accents]
...
❌ Prompts sans les codes hex de la palette Appréciez Votre Vie

---

Génère maintenant l'article.`
      : // Mode simple (legacy) si AVV désactivé
        `Tu es un rédacteur spécialisé en sophrologie, somatothérapie et thérapies alternatives pour le blog Appréciez Votre Vie.
...
1. Le style d'écriture AVV (défini dans ton système)
...
**Retourne uniquement le contenu amélioré en Markdown**, sans balises XML additionnelles.`
      : `Tu es un éditeur spécialisé en sophrologie pour le blog Appréciez Votre Vie.
