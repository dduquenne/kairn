...
// Site ID for Appréciez Votre Vie (in a real multi-tenant setup, this would come from context)
const SITE_SLUG = "avv";
const SITE_DOMAIN = "appreciezvotrevie.fr";
const SITE_NAME = "Appréciez Votre Vie";
