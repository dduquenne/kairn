...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const prompt = `Tu es un expert en analyse de données web et en optimisation de conversion. Analyse les données analytics suivantes d'un site de sophrologie (Appréciez Votre Vie) et génère 3-5 insights actionnables.
...
2. Pour chaque insight, explique POURQUOI c'est important pour un site de sophrologie
