...
async function sendEmailNotification(
  ...
  const response = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      from: process.env.ALERT_EMAIL_FROM || 'Appréciez Votre Vie Analytics <analytics@appreciezvotrevie.fr>',
      to: recipients,
      subject: `[Alerte] ${alertName} - Appréciez Votre Vie Analytics`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #1a1a2e; padding: 20px; text-align: center;">
            <h1 style="color: #D4AF37; margin: 0;">Appréciez Votre Vie Analytics</h1>
          </div>
          ...
          <div style="padding: 15px; background-color: #1a1a2e; text-align: center;">
            <p style="color: #888; font-size: 12px; margin: 0;">
              Cet email a ete envoye automatiquement par Appréciez Votre Vie Analytics
            </p>
          </div>
        </div>
      `,
