        ...
        <tbody>
          {conversations.map(conv => (
            <tr key={conv.id} className="border-gold/10 hover:bg-gold/5 border-b transition">
              ...
              <td className="min-w-0 max-w-[200px] px-3 py-3 sm:max-w-xs">
                <button
                  onClick={() => onView(conv)}
                ...
                >
                  ...
                  <div className="mt-0.5 flex items-center gap-2 sm:hidden">
                    ...
                    <span className="text-ivory/40 text-xs">{formatDate(conv.createdAt)}</span>
                  </div>
                  {conv.referrer && (
                    <p className="text-ivory/40 mt-0.5 hidden truncate text-xs sm:block">
              ...
              <td className="text-ivory/50 hidden whitespace-nowrap px-3 py-3 sm:table-cell">
              ...
              <td className="px-3 py-3 text-right">
                <div className="flex items-center justify-end gap-1">
                  ...
                  <button
                    ...
                    className="text-ivory/60 hidden rounded-md px-2 py-1 text-xs transition hover:bg-rose-400/10 hover:text-rose-400 sm:block"
                    title="Supprimer"
                  >
                    Suppr.
                  </button>
