  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="flex items-center gap-3 p-4">
        ...
        <div>
          <p className="font-semibold text-gray-900">Appréciez Votre Vie</p>
  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="flex items-start gap-3 p-4">
        ...
        <div>
          <p className="font-semibold text-gray-900">Nathalie Duquenne</p>
          <p className="text-sm text-gray-500">
            Sophrologue • Somatothérapie
          </p>
  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="flex items-center gap-3 p-3">
        ...
        <p className="font-semibold text-gray-900">avv</p>
      </div>
      ...
      <div className="px-3 pb-4">
        <p className={styles.contentClass}>
          <span className="font-semibold">avv</span> {content}
        </p>
        {hashtags.length > 0 && (
      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-1">
            <span className="font-bold text-gray-900">Appréciez Votre Vie</span>
            <span className="text-gray-500">@avv</span>
  ...
  return (
    <div className="p-4">
      <div className="flex gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            <span className="font-semibold text-gray-900">avv</span>
            <span className="text-gray-500">• Maintenant</span>
          </div>
