/**
 * Page d'accueil Appréciez Votre Vie - Server Component
 *
 ...
 *
 * @version 1.0.0 - ISR enabled (revalidate=120s) for CDN caching
 */
...
import { BreathworkSection, ContactSection } from './(pages)/sections/dynamic-sections';
