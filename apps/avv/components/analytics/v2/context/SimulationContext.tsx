...
function generateSimulatedData(
  ...
  const blogArticles: BlogArticleStats[] = [
    ...
    {
      slug: 'somatothérapie-therapeutique',
      title: "La somatothérapie thérapeutique expliquée",
    ...
    topQuestions: [
      {
        ...
        articleSlug: 'somatothérapie-therapeutique',
        opens: randomInRange(20, 50),
      },
      {
        question: "La somatothérapie fonctionne-t-elle sur tout le monde ?",
        articleSlug: 'somatothérapie-therapeutique',
  ...
  const postContents = [
    ...
    "Témoignage : comment la somatothérapie m'a aidé à surmonter mon anxiété",
    ...
    "Question fréquente : combien de séances de somatothérapie sont nécessaires ?",
