        ...
        <>
          ...
          >
            <div className="space-y-4 text-sm leading-relaxed">
              ...
              <p>
                Le règlement de l'acompte est à effectuer par chèque (encaissé après le séminaire) à l'ordre de <strong>Appréciez Votre Vie</strong> et à adresser à :
              </p>
              <p className="text-center text-base font-semibold">
                Nathalie Duquenne<br />Le Moulin d'en Bas<br />89330 Saint-Julien-du-Sault
              </p>
