...
const navLinks = [
  { href: '/', label: 'Accueil' },
  { href: '/sophrologie', label: 'Sophrologie' },
  { href: '/somatotherapie', label: 'Somatothérapie' },
  { href: '/breathwork', label: 'Breathwork' },
  { href: '/coherence-cardiaque', label: 'Cohérence Cardiaque' },
...
const socialLinks = [
  ...
  {
    platform: 'Instagram',
    url: 'https://www.instagram.com/appreciezvotrevie/',
...
/** Logo AVV SVG */
function AvvLogo({ size = 36, className = '' }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
      viewBox="0 0 600 600"
      aria-label="Logo Appréciez Votre Vie"
      className={`text-gold ${className}`}
    >
      <circle cx="300" cy="300" r="250" fill="none" stroke="currentColor" strokeWidth="30" />
      <path
        d="M 200 420 L 300 180 L 400 420 M 240 340 L 360 340"
        fill="none"
        stroke="currentColor"
        strokeWidth="30"
        strokeLinecap="round"
    ...
    <>
      ...
      >
        ...
        <div className="border-gold/20 flex items-center gap-3 border-b px-6 py-5">
          <AvvLogo size={40} />
          <span className="font-display text-gold-accessible text-xl font-semibold">Appréciez Votre Vie</span>
        </div>
