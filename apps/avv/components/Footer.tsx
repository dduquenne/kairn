...
const SERVICE_LINKS = [
  { name: 'Sophrologie & Relaxation', href: '/sophrologie' },
  { name: 'Somatothérapie', href: '/somatotherapie' },
  { name: 'Breathwork & Rebirth', href: '/breathwork' },
  { name: 'Cohérence Cardiaque', href: '/coherence-cardiaque' },
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span className="text-sm">06 10 09 22 49</span>
              </a>
              ...
              >
                <MailIcon />
                <span className="text-sm">dduquenne@appreciezvotrevie.fr</span>
              </a>
            </div>
            ...
            <div className="bg-night/50 border-gold/20 mt-4 rounded-lg border p-3">
              <p className="text-gold-accessible text-xs font-medium">
                Sophrologue, Relaxologue &amp; Somatothérapeute à Saint-Julien-du-Sault (89)
              </p>
          ...
          <div className="space-y-4">
            ...
            <div className="border-ivory/10 mt-4 border-t pt-4">
              <p className="text-ivory-muted mb-2 text-xs">Sophrologie</p>
            ...
            <div className="border-ivory/10 mt-4 border-t pt-4">
              <p className="text-ivory-muted mb-2 text-xs">Somatothérapie</p>
              <div className="flex flex-wrap gap-2">
                <Link
                ...
                <Link
                  href="/somatotherapie-joigny"
                  className="bg-ivory/5 text-ivory-muted hover:text-gold-accessible rounded px-2 py-1 text-xs transition-colors"
                >
                  Joigny
                </Link>
                <Link
                  href="/somatotherapie-migennes"
                  className="bg-ivory/5 text-ivory-muted hover:text-gold-accessible rounded px-2 py-1 text-xs transition-colors"
                >
                  Migennes
                </Link>
                <Link
                  href="/somatotherapie-sens"
                  className="bg-ivory/5 text-ivory-muted hover:text-gold-accessible rounded px-2 py-1 text-xs transition-colors"
                >
                  Sens
                </Link>
                <Link
                  href="/somatotherapie-auxerre"
                  className="bg-ivory/5 text-ivory-muted hover:text-gold-accessible rounded px-2 py-1 text-xs transition-colors"
                >
                  Auxerre
                </Link>
        ...
        <div className="mx-auto max-w-7xl px-6 py-6 sm:px-10 lg:px-16">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <div className="text-ivory-muted text-center text-xs md:text-left">
              <p>
                © <CurrentYear /> Appréciez Votre Vie - Nathalie Duquenne. Tous droits réservés.
              </p>
              <p className="mt-1">Sophrologue, Relaxologue &amp; Somatothérapeute à Saint-Julien-du-Sault • Yonne (89) • Bourgogne</p>
            </div>
