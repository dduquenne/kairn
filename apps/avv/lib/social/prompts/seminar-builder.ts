...
// ===========================================
// Contexte Appréciez Votre Vie pour les séminaires
// ===========================================

const AVV_SEMINAR_CONTEXT = `Tu es un expert en communication digitale pour un cabinet de sophrologie.
...
- Page Breathwork & Rebirth : https://www.appreciezvotrevie.fr/breathwork
- Inscription séminaire : https://www.appreciezvotrevie.fr/inscription-seminaire
...
export function buildSeminarSystemPrompt(): string {
  return `${AVV_SEMINAR_CONTEXT}

MISSION:
Tu vas générer du contenu pour les réseaux sociaux de Appréciez Votre Vie afin de promouvoir un séminaire.
...
3. Appel à l'action CLAIR :
   - Inciter à s'inscrire via "lien en bio" (le lien en bio pointe vers https://www.appreciezvotrevie.fr/inscription-seminaire)
   - Mentionner la page https://www.appreciezvotrevie.fr/breathwork pour en savoir plus sur la pratique
...
LIENS À UTILISER:
- Page d'inscription: https://www.appreciezvotrevie.fr/inscription-seminaire
- En savoir plus sur la pratique: https://www.appreciezvotrevie.fr/breathwork
...
{
  "content": "Le contenu du post LinkedIn (avec \\n pour les sauts de ligne). Mentionner le lien https://www.appreciezvotrevie.fr/inscription-seminaire en commentaire et/ou https://www.appreciezvotrevie.fr/breathwork pour en savoir plus.",
...
- Paragraphes ULTRA-COURTS (1-3 lignes)
- Question d'engagement en fin de post
- Mentionner les vrais liens (https://www.appreciezvotrevie.fr/inscription-seminaire et https://www.appreciezvotrevie.fr/breathwork) "en commentaire"`;
}
...
• Inclure le VRAI lien vers l'inscription : 👉 https://www.appreciezvotrevie.fr/inscription-seminaire
• Référencer la page de la pratique : https://www.appreciezvotrevie.fr/breathwork
...
{
  "content": "Le contenu du post Facebook (avec \\n pour les sauts de ligne). Utiliser les vrais liens https://www.appreciezvotrevie.fr/inscription-seminaire et https://www.appreciezvotrevie.fr/breathwork.",
...
Le lien https://www.appreciezvotrevie.fr/inscription-seminaire sera ajouté automatiquement, ne l'inclus PAS dans le contenu.
...
LIENS À UTILISER:
- Page d'inscription: https://www.appreciezvotrevie.fr/inscription-seminaire
- En savoir plus: https://www.appreciezvotrevie.fr/breathwork
...
3. Appel à l'action CLAIR :
   - Inciter à s'inscrire via https://www.appreciezvotrevie.fr/inscription-seminaire
   - Référencer https://www.appreciezvotrevie.fr/breathwork pour en savoir plus
...
3. APPEL À L'ACTION: Inciter à s'inscrire via https://www.appreciezvotrevie.fr/inscription-seminaire
4. LIENS: Utiliser les vrais liens du site (inscription + page breathwork & rebirth)
