...
export const INSTAGRAM_FORMATS: Record<InstagramPostFormat, InstagramFormatSpec> = {
  hook_reveal: {
    ...
    example: `Stop. Ce que vous croyez savoir sur la somatothérapie est probablement faux.

Non, vous n'allez pas aboyer comme un chien.
Non, vous ne perdrez pas le contrôle.

L'somatothérapie, c'est simplement une conversation avec votre inconscient.
...
#burnout #fatigue #bienetre #ecouter`,
  ...
  micro_storytelling: {
    ...
    example: `Il y a 5 ans, je ne croyais pas à la somatothérapie.
...
.
.
#somatothérapie #transformation #developpementpersonnel`,
...
Cet espace, c'est exactement ce que la somatothérapie permet d'agrandir.
...
.
.
#citation #viktorfrankl #somatothérapie #changement`,
...
export const INSTAGRAM_HOOK_PATTERNS: HookPattern[] = [
  {
    ...
    examples: [
      'Stop. L\'somatothérapie n\'est pas ce que vous croyez.',
  ...
  },
  {
    ...
    examples: [
      ...
      '9 personnes sur 10 confondent somatothérapie et manipulation.',
  ...
  },
  {
    ...
    examples: [
      ...
      'Ce que personne ne vous dit sur l\'somatothérapie...',
...
export const AUTHENTICITY_LEVELS: Record<AuthenticityLevel, AuthenticitySpec> = {
  1: {
    ...
    exampleOpening: 'La breathwork & rebirth est une technique qui...',
  },
  2: {
    level: 2,
...
export const INSTAGRAM_HASHTAG_DATABASE: HashtagCategory[] = [
  ...
  {
    id: 'somatothérapie_niche',
    name: 'Somatothérapie (niche)',
    tier: 'niche',
...
export function generateBalancedHashtags(
  ...
  const themeKeywords: Record<string, string[]> = {
    somatothérapie: ['somatothérapie_niche', 'bienetre_medium', 'lifestyle_large'],
