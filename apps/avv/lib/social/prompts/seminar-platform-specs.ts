...
→ Breathwork & rebirth et pratiques douces
...
Au programme :
• Pratiques de breathwork & rebirth
...
export const SEMINAR_HASHTAG_CATEGORIES = {
  ...
  practice: ['respiration', 'respirationholotropique', 'somatothérapie', 'meditation', 'bienetre'],
