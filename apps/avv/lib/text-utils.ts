 ...
 *
 * @example
 * containsKeyword("Sophrologie et Relaxation", "psychotherapie") // true
 * containsKeyword("État modifié de conscience", "etat") // true
 * containsKeyword("Somatothérapie", "thérapie") // false
 */
 ...
 * containsAnyKeyword("Méditation guidée", ["somatothérapie", "yoga"]) // false
 */
 ...
 *
 * @example
 * tagsMatchKeywords(["sophrologie", "stress"], ["therapie"]) // true (psychoTHERAPIE contient THERAPIE)
 * tagsMatchKeywords(["coaching", "sport"], ["somatothérapie", "anxiété"]) // false
 */
