...
/**
 * Onglet de gestion des objectifs analytics.
 * Affiche la liste des objectifs, les modèles prédéfinis et permet la création/édition/suppression.
 */
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-ivory/60 text-sm">
            ...
            {goals.length !== 1 ? 's' : ''}, {enabledGoals.length} actif
            {enabledGoals.length !== 1 ? 's' : ''}
          </p>
        </div>
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex items-center gap-2 rounded-xl border border-emerald-500/30 bg-emerald-500/10 px-4 py-2.5 text-sm font-medium text-emerald-400 transition-all hover:bg-emerald-500/20"
          >
