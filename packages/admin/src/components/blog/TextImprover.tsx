 ...
 * Text Improver Modal
 *
 * Modal for improving selected text snippets with Claude AI.
...
/**
 * Modal d'amélioration de texte sélectionné avec Claude AI
 */
            ...
            <div className="border-gold/20 from-night/95 to-night/90 w-full max-w-2xl rounded-lg border bg-gradient-to-br p-6 shadow-2xl backdrop-blur-xl">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <label htmlFor="useSiteStyleText" className="text-ivory text-sm font-medium">
