 ...
 *
 * Robust image components for blog admin with loading states,
 * error handling, cache-busting, and retry functionality.
 */
 ...
 * - Chemins locaux (/images/blog/...) : routés via /api/blog/image
 *
 ...
 * @returns Chemin nettoyé sans paramètres de requête
 */
...
interface BlogImageProps {
  ...
  onError?: () => void;
  /** Clé unique pour forcer le rechargement */
