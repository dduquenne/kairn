 ...
 *
 * Modal for improving entire article content with Claude AI.
 * Uses site style label from BlogAdminContext.
 */
...
/**
 * Modal d'amélioration d'article complet avec Claude AI
 */
export function ArticleImprover({
  ...
  const { siteStyleLabel } = useBlogAdminConfig();
            ...
            <div className="border-gold/20 from-night/95 to-night/90 w-full max-w-2xl rounded-lg border bg-gradient-to-br p-6 shadow-2xl backdrop-blur-xl">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <label htmlFor="useSiteStyleImprover" className="text-ivory text-sm font-medium">
