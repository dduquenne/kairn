...
**Jobs-to-be-Done** — Formuler chaque besoin comme : _"Quand [situation], je veux [action], pour [résultat]."_
...
Demander validation : _"Cette structure vous convient-elle ? Je peux ajuster avant
de détailler les User Stories."_
