...
| --------------------------------- | ------------------- | ---------------------- |
| Sécurité, CVE, injection, XSS     | securix             | testix                 |
| Migration SQL, index, RLS         | databasix, migratix | —                      |
| Variables d'environnement, config | securix, deploix    | —                      |
| Performance, cache, build         | optimix             | —                      |
| Email, templates                  | —                   | testix                 |
| UI, composants, accessibilité     | ergonomix           | testix                 |
| Tests, couverture                 | testix              | —                      |
| Dépendances, package.json         | securix             | deploix                |
| RGPD, données personnelles        | rgpdix              | securix, databasix     |
| Console.log, typo, cleanup        | —                   | —                      |
