...
- **Termes anglais conservés** quand ils sont les plus usités dans l'écosystème technique :
  ...
  `pull request`, `merge`, `branch`, `runtime`, `skill`, etc.
...
| Ignorer le contexte du projet          | Réponse générique moins utile                | Toujours relier au contexte du projet quand c'est pertinent                  |
