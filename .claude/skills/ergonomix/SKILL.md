...
1. Identifier le module cible
2. Lire la checklist `_common/ui-spec-checklist.md`
3. Ouvrir la SFD de l'app (ex : `docs/specs/SPC-0003-...`) et localiser
   la User Story + les règles de gestion de l'écran
4. Consulter la maquette SVG de l'écran dans `docs/<app>/mockups/`
5. Vérifier la palette de couleurs dans `src/styles/theme.css`
6. Identifier les composants réutilisables existants (`src/components/`)
