# Checklist RGAA — Correspondance WCAG et composants Link's

## Correspondance RGAA / WCAG

Le RGAA (Référentiel Général d'Amélioration de l'Accessibilité) est l'implémentation française
du WCAG. Pour les applications métier françaises comme celles de Link's Accompagnement, la conformité RGAA
peut être exigée contractuellement.

| Thématique RGAA          | Critères WCAG | Composants Link's concernés            |
| ------------------------ | ------------- | -------------------------------------- |
